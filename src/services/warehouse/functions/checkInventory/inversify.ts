...
import { CheckInventoryUseCase } from '../../../../context/warehouse/application/command/CheckInventoryUseCase';
...
container.bind<UseCase<InventoryCheckRequest, void>>(types.CheckInventoryUseCase).to(CheckInventoryUseCase);
